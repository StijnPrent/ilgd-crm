...
export function ShiftManager() {
    ...
    const [newShift, setNewShift] = useState({
        ...
        end_minute: "",
        isWeekly: false,
        recurrenceParentId: NO_OVERRIDE_VALUE,
    })
    ...
    const handleAddShift = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await api.createShift({
                ...
                ...(newShift.recurrenceParentId !== NO_OVERRIDE_VALUE
                                ...
                                <form onSubmit={handleAddShift} className="space-y-4">
                                        ...
                                        <Switch
                                            ...
                                            onCheckedChange={(checked) =>
                                                setNewShift((prev) => ({
                                                    ...prev,
                                                    isWeekly: checked,
                                                    recurrenceParentId: checked ? NO_OVERRIDE_VALUE : prev.recurrenceParentId,
                                                }))
                                            }
                                        />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        >
                                            ...
                                            <SelectContent>
                                                <SelectItem value={NO_OVERRIDE_VALUE}>Geen override</SelectItem>
